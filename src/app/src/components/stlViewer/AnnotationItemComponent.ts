...
${this.props.annotation.text}
                ...
                ${!this.state.isEditMode &&
                html`<div class="annotation-content" dangerouslySetInnerHTML=${{ __html: annotationText }}></div>
        ...
        return html`<div className=${this.css()}>
            <div
                ...
                ref=${(numberContainer: HTMLElement) => {
                    this._numberContainerElement = numberContainer;
                }}
