...
call candle PrintProjects.App.wxs Files.wxs -ext WixUIExtension -ext WixUtilExtension

echo Executing Light 
call light PrintProjects.App.wixobj Files.wixobj -ext WixUIExtension -ext WixUtilExtension -b bin/Release/netcoreapp3.1/win-x64/publish -o 3D2P